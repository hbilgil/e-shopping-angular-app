export class DetailsService {
    details = [
        ...
        },
        {
            ...
            Body: 84-85% cotton/15-16% polyester. Rib: 98% cotton/2% spandex.
        ...
        },
        {
            ...
            Weight: 312g/11.0oz (Men's size 10)
        ...
        },
        {
            ...
            responsive Zoom Air unit under the forefoot. The Max Air helps to dissipate impact forces, 
            while the Zoom Air helps drive you down the court. The bottom of the shoe is designed to 
        ...
        },
        {
            ...
            targeted areas of support, stretch and breathability. It provides security and comfort.
        ...
        },
        {
            ...
            Fabric: Body: 80% cotton/20% polyester. Hood lining: 100% cotton.`,
            care:`Machine wash`,
        },
        {
            id: 33,
